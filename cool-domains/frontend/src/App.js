...
const tld = '.ly';
const CONTRACT_ADDRESS = '0x426C060Bfdf796b2DEC127372D4A954663c90947';
...
const App = () => {
	...
	const renderNotConnectedContainer = () => (
		<div className="connect-wallet-container">
			<img src="https://media0.giphy.com/media/xT5LMAs2NqesxdXwvC/giphy.gif?cid=ecf05e47p3sviq5tw8roy1cybiyjzfm0sbh2fgaan4bl4zpw&rid=giphy.gif&ct=g" alt="Dictionary gif" />
		...
		return (
			<div className="form-container">
				...
				<input
					type="text"
					value={record}
					placeholder='description or comment here'
